...
echo "  3. Get SSL cert: certbot --nginx -d bff.apmcb.com.br"
echo "  4. Copy certs: cp /etc/letsencrypt/live/bff.apmcb.com.br/fullchain.pem /var/www/apmcb/nginx/ssl/"
echo "  5. Start: cd /var/www/apmcb && docker compose up -d"
