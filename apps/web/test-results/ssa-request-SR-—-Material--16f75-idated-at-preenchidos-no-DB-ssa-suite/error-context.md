...
- Name: ssa-request.spec.ts >> SR — Material Request (Cadete) >> SR18 - totp_validated=true e totp_validated_at preenchidos no DB
- Location: e2e\ssa-request.spec.ts:239:7
