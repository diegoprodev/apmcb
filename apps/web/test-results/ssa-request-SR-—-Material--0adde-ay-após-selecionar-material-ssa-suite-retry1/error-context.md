...
- Name: ssa-request.spec.ts >> SR — Material Request (Cadete) >> SR12 - UI: avança para Passo 2 com TOTPDisplay após selecionar material
- Location: e2e\ssa-request.spec.ts:164:7
