...
- Name: ssa-request.spec.ts >> SR — Material Request (Cadete) >> SR04 - POST /requests cria solicitação com status 'pendente' e TOTP válido
- Location: e2e\ssa-request.spec.ts:61:7
