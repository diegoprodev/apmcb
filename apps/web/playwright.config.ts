...
export default defineConfig({
  ...
  // 1 retry em CI (não 2): a suíte bate em produção, e cada tentativa extra
  // multiplica invocações de Function do CF Pages. Projetos sabidamente
  // frágeis mantêm override próprio abaixo.
